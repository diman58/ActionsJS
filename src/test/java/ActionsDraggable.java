...
public class ActionsDraggable {
    ...
    public void dragElement() {
        ...
        //System.out.println(draggable.getLocation().getX());
        //System.out.println(draggable.getLocation().getY());
   ...
   /* @Test(description = "Draggable2")
    ...
    public void dropElement() throws InterruptedException {
        ...
        new Actions(driver).clickAndHold(draggable).moveByOffset(10,
                10).release().build().perform();
    }

    /*@Test(description = "ClickAndHold")
    public void chooseElements () throws InterruptedException, AWTException {
